...
main_dir = "/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/PCA/HOMER_result_5000/"
...
for(i in 1:length(topN))
{
  for(j in 1:length(pcs))
  {
    ...
    file_name_up = paste0("/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/PCA/", pcs[j], "_",topN[i], "_up_peak.bed")
    file_name_down = paste0("/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/PCA/", pcs[j], "_",topN[i], "_down_peak.bed")
    file_name_bg = paste0("/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/PCA/", pcs[j],  "_bg_peak.bed")
