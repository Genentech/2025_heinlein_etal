...
dar = fread("/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/merged_afterNorm_tmm_report_vivo_vitro_P5_p5.tsv",
            stringsAsFactors = F, data.table = F)%>%
  dplyr::arrange(Fold)


main_dir = "/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/HOMER_result/merged_vivo_vitro_P5_p5/"
