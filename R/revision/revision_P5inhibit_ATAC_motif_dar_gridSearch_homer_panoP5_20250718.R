...
dar = fread("/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/crc_afterNorm_tmm_report_pano_p5.tsv",
            stringsAsFactors = F, data.table = F)
main_dir = "/gstore/project/crc_metastasis/revision/P5_inhibit_ATAC/HOMER_result/Pano_P5/"
